...
public class TestUtils {
    ...
    public static final Map<String, NsvData> SAMPLES_DATA = Map.ofEntries(
        entry("empty", new NsvData(List.of(), List.of())),
        entry("empty_one", new NsvData(List.of(), List.of(List.of()))),
        entry("empty_two", new NsvData(List.of(), List.of(List.of(), List.of()))),
        entry("empty_three", new NsvData(List.of(), List.of(List.of(), List.of(), List.of()))),
        entry("basic", new NsvData(List.of(), List.of(
        ...
        entry("empty_fields", new NsvData(List.of(), List.of(
            List.of("r1c1", "", "r1c3"),
            List.of("r2c1", "", "r2c3")
        ))),
        entry("empty_sequence", new NsvData(List.of(), List.of(
            List.of("r1c1", "r1c2"), 
            List.of(), 
            List.of("r3c1", "r3c2")
        ))),
        entry("empty_sequence_end", new NsvData(List.of(), List.of(
            List.of("r1c1", "r1c2"), 
            List.of("r2c1", "r2c2"), 
            List.of()
        ))),
        entry("empty_sequence_start", new NsvData(List.of(), List.of(
            List.of(), 
            List.of("r2c1", "r2c2"), 
            List.of("r3c1", "r3c2")
        ))),
        entry("special_chars", new NsvData(List.of(), List.of(
        ...
        entry("multiple_empty_sequences", new NsvData(List.of(), List.of(
            List.of(),
            List.of("r2c1", "r2c2"),
            List.of(),
            List.of(),
        ...
        entry("multiline_encoded", new NsvData(List.of(), List.of(
            List.of("line1\nline2", "r1c2", "r1c3"),
